...
```
  gh-agent-viz  a gh CLI extension to see what your agents are up to
  gh-art  Famous art in your terminal
  ...
  gh-ghostty  Change your ghostty theme via the gh cli
  gh-hearth  🔥 A roaring fire for your terminal — a GitHub CLI extension
  gh-onion  America's finest news source in your terminal
  ...
  gh-repo-peek  Quick repo stats at a glance — a GitHub CLI extension
  gh-slim-vtt  A tiny GH CLI extension for slimming down vtt files
  gh-sportsball  Watch live games in your terminal. Scores, play-by-play, stan
  gh-spotify  Spotify in your terminal
  gh-wut  What do I need to know right now? — a GitHub CLI extension
  gh-yt2md  YouTube to Markdown - gh CLI extension
```
